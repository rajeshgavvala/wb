...
import 'package:mobile_app/user/model/user.dart';
...
class _UserSignupState extends State<UserSignup> {
  ...
  Future<UserDetails> _futureUserAttributes;
  ...
  Future<UserDetails> createNewUser(String email, String mobile, String password) async {
    final http.Response response = await http.post(
    'https://dry-meadow-98225.herokuapp.com/wbapi/auth/user/signup',
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        child: new Form(
          ...
          child:(_futureUserAttributes == null) ? runGUI() : FutureBuilder<UserDetails>(
